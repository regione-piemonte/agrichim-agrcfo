...
<%
  ...
  */
  ...
  String controllaAnagrafica=anagrafica.controllaAnagrafica();
  if (controllaAnagrafica == null)
  {
  ...
  else Utili.forwardConParametri(request, response, "/jsp/view/anagraficaUtenteLAR.jsp?anagraficaDup="+controllaAnagrafica);
%>