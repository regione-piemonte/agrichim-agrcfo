	...
	$.widget('ui.multiAccordion', {
		options: {
			...
			_classes: {
				...
				h3: 'ui-accordion-header ui-helper-reset ui-state-default ui-corner-all ui-accordion-icons', //ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top ui-accordion-icons
				div: 'ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom',
				divActive: 'ui-accordion-content-active',
				span: 'ui-icon ui-icon-triangle-1-e ui-accordion-header-icon', //.ui-accordion .ui-accordion-header .ui-accordion-header-icon
