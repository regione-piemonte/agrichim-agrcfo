...
intentionally break the chain instead of hiding errors subtly).
    ...
    _addLayer: function(options) {
        ...
        // TODO: da problemi con editing
        // TODO: da problemi con KML
        if (layer.isVector) {
...
$.MapQuery.Layer = function(map, id, options) {
    ...
    if (typeof(options)!="undefined" && typeof(options.cartellaToc)!="undefined")
        this.cartellaToc = options.cartellaToc;
    else
        this.cartellaToc = "";

    if (typeof(options)!="undefined" && typeof(options.noDelete)!="undefined")
        this.noDelete = options.noDelete;
    else
        this.noDelete = false;

    if (typeof(options)!="undefined" && typeof(options.maxExtent)!="undefined")
        this.maxExtent = options.maxExtent;
    else
        this.maxExtent = null;

    if (typeof(options)!="undefined" && typeof(options.label)!="undefined")
