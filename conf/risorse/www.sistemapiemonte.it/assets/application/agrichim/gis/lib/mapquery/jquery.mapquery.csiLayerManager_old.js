...
/**
#jquery.mapquery.csiLayerManager.js
The file containing the csiLayerManager Widget

### *$('selector')*.`csiLayerManager([options])`
_version added 0.1_
...
The csiLayerManager allows us to control the order, opacity and visibility
 ...
 */
(function($) {
$.template('csiLayerManagerToolbar',
    '<div class="mq-layermanager-toolbar ui-widget-content  ">'+
        '<button id="mqLayManTool_allOn" >Tutto ON</button>'+
        '<button id="mqLayManTool_allOff" >Tutto OFF</button>'+
    '</div>');
...
$.widget("mapQuery.csiLayerManager", {
    ...
    _create: function() {
        ...
        // toolbar della toc
        var lmToolbar = $.tmpl('csiLayerManagerToolbar').appendTo(element);
