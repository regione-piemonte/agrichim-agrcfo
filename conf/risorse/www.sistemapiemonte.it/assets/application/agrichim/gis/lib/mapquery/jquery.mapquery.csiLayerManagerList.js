...
(function($) {
$.template('csiLayerManagerListToolbar',
...
$.template('csiLayerManagerList',
    '<div class="mq-layermanager ui-widget-content  ">'+
    '</div>');

$.template('csiLayerManagerListElement',
...
$.widget("mapQuery.csiLayerManagerList", {
    options: {
    ...
    _create: function() {
        ...
        // toolbar della toc
        var lmToolbar = $.tmpl('csiLayerManagerListToolbar',{
        ...
        // contenuto della toc
        var lmElement = $.tmpl('csiLayerManagerList').appendTo(element);
    ...
    _layerAdded: function(widget, layer) {
        ...
        var layerElement = $.tmpl('csiLayerManagerListElement',{
            id: layer.id,
            label: layer.label,
       ...
       // GESTIONE LIVELLI DEL WMS
        if(isWMS)
        {
            ...
            // contenitore livelli WMS
            $("#mq-WMSlayermanager-container-"+layer.id).csiWMSLayerManager({layer: layer});
        }
